...
#[derive(Debug)]
pub struct DevInterfaceProcessor {
    verbose: bool,
    processed_count: usize,
}

impl DevInterfaceProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting DevInterface processing");
    
    let mut processor = DevInterfaceProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = DevInterfaceProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = DevInterfaceProcessor::new(false);
